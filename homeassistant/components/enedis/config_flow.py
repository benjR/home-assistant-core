...
from .const import CONF_ACCESS_TOKEN, CONF_REFRESH_TOKEN, CONF_USAGE_POINT_ID, DOMAIN, OAUTH2_AUTHORIZE, AUTH_CALLBACK_NAME, AUTH_CALLBACK_PATH, OAUTH2_TOKEN
...
class EnedisLocalOAuth2Implementation(config_entry_oauth2_flow.LocalOAuth2Implementation):
...
class EnedisAuthorizationCallbackView(HomeAssistantView):
    ...
    async def get(self, request: web.Request) -> web.Response:
        ...
        _LOGGER.error("EnedisAuthorizationCallbackView")
        ...
        hass.data[DOMAIN][request.query["flow_id"]].refresh_token = request.query["refresh_token"]
